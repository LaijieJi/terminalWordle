...
class TerminalWordle{
    ...
    public void startGame(){
        ...
        for(int i = 0; i < 5 && !guessed; i++) {
            ...
            if(ans.length() != 5){
                System.out.println("Wrong format, remember that your guess consists of 5 characters");
            } else {
        ...
        if(guessed) {
            System.out.println(BOLD + GREEN_BACKGROUND + "Congratulations, you've nailed it!!" + RESET);
        } else {
            System.out.println(BOLD + BLUE_BACKGROUND + "Ohh, I'm sorry, you didn't guess it, the wordle was: " + getWordle() + RESET);
        }
    }
